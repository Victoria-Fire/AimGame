...
function finishGame() {
    ...
    board.innerHTML = `<div class='finish-game'><h1>Счет: <span class="primary">${score}</span></h1><a class='play-again'>Сыграть еще раз</a></div>`
...
function winTheGame() {
    ...
    setInterval(kill, getRandomNumber(30, 150))
}
